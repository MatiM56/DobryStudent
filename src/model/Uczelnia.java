    ...
    public Uczelnia() {
        super("Uczelnia", Arrays.asList(
            ...
            new Event(
                ...
                new int[]{0, 0, 4, 0, 5, 0, 0, -3, 0, -3}, // +asertywnosc, +samowiadomosc, -agresja, -impulsywnosc
            ...
            new Event(
                ...
                new int[]{5, 0, 0, 0, 0, -4, 0, -2, 6, 0}, // +empatia, -egocentryzm, +wspolpraca, -impulsywnosc
            ...
            new int[]{0, 0, 4, 0, 5, 0, 3, -3, 0, 0}, // +asertywność, +samowiaromość, +współpraca, -impulsywnosc
