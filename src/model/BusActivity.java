...
/**
 * Klasa reprezentująca aktywności i zdarzenia związane z jazdą autobusem.
 * Zawiera scenariusze takie jak interakcja z innymi pasażerami czy sytuacje losowe w transporcie.
 */
public class BusActivity extends Event.ActivityType {
    /**
     * Konstruktor inicjalizujący listę zdarzeń dla aktywności w autobusie.
     * Definiuje możliwe scenariusze, wybory oraz ich wpływ na cechy studenta.
     */
    public BusActivity() {
