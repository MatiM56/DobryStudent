...
/**
 * Klasa reprezentująca aktywności i zdarzenia związane z impezami i życiem towarzyskim.
 * Zawiera scenariusze interakcji ze znajomymi, konfliktów i zabawy.
 */
public class Impreza extends Event.ActivityType {
    /**
     * Konstruktor inicjalizujący listę zdarzeń dla aktywności Impreza.
     */
    public Impreza() {
