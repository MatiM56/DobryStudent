...
/**
 * Klasa reprezentująca aktywności i zdarzenia związane z pracą zawodową.
 * Zawiera scenariusze relacji z szefem, współpracy w zespole i wyzwań zawodowych.
 */
public class Praca extends Event.ActivityType {
    /**
     * Konstruktor inicjalizujący listę zdarzeń dla aktywności Praca.
     */
    public Praca() {
